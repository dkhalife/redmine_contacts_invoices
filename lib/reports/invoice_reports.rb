  ...
  module InvoiceReports
    class << self
      ...
      def classic_table(pdf, invoice)
        ...
        lines << ['', '', '', '', l(:field_invoice_line_tax_amount) + ":", price_to_currency(invoice.tax_amount, invoice.currency, :converted => false, :symbol => false)]
      ...
      def invoice_to_pdf_modern(invoice, options={} )
        ...
        pdf.bounding_box [(pdf.bounds.width / 2) + 20, pdf.cursor], :width => (pdf.bounds.width / 2) - 20  do
          pdf.font_size(11) do
			...
			invoice_total << [l(:field_invoice_line_tax_amount) + ":", price_to_currency(invoice.tax_amount, invoice.currency, :converted => false, :symbol => false)]
